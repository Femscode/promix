...
namespace App\Abstracts\View\Components\StudentClass;
...
abstract class Index extends Component
{
    ...
    public const OBJECT_TYPE = 'studentclass';
    public const DEFAULT_TYPE = 'studentclass';
    public const DEFAULT_PLURAL_TYPE = 'studentclasses';
    ...
    public function __construct(
        string $type, $studentclasses = [], $contacts = [], string $textPage = '', string $group = '', string $page = '',
        ...
        $this->studentclasses = StudentClass::latest()->collect();;
