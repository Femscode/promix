...
Route::group(['prefix' => 'sales'], function () {
    ...
    Route::get('invoices/create-bulk', 'Sales\Invoices@create_bulk')->name('invoices.create-bulk');
    ...
    // Route::resource('classes', 'Sales\Classes');
    Route::resource('studentclasses', 'Sales\StudentClass');
    // Route::resource('studentclass', 'Sales\StudentClass');
    // Route::resource('studentclasses', 'Sales\StudentClass');
    // Route::resource('studentclasses', 'Sales\StudentClasses');
    Route::get('class', 'Sales\StudentClasses@classIndex')->name('studentclasses.export');
    // Route::get('/create-class', 'Sales\StudentClasses@createClass')->name('class.create');
    Route::get('/cancel-class', 'Sales\StudentClass@cancelClass')->name('class.cancel');
    // Route::post('/save-class', 'Sales\StudentClasses@saveClass')->name('class.store');   
    Route::get('/edit-class/{id}', 'Sales\StudentClass@editClass')->name('class.edit');   
    Route::post('/update-class', 'Sales\StudentClass@updateClass')->name('class.update');   
    Route::get('/delete-class/{id}', 'Sales\StudentClass@deleteClass')->name('class.delete');   
});
