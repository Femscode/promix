...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('public/img/christabel.ico') }}" type="image/png">
    ...
    <script type="text/javascript">
        ...
        var flash_notification = {
            !!(session() - > has('flash_notification')) ? json_encode(session() - > get('flash_notification')) : 'false'!!
        };
        //
        -->
    </script>
