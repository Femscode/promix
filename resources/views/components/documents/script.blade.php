@push('scripts_start')
    ...
    @endphp
    <!-- <script src="https://app.akaunting.com/public/js/common/documents.min.js?v=3.1.14" defer></script>
<script src="https://app.akaunting.com/manifest.json" defer></script> -->
