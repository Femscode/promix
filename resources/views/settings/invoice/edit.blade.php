<x-layouts.admin>
    <script src="{{ url('js/settings/settings.min.js?v=3.1.14') }}"></script>
    <x-slot name="title">
                        ...
                        <div class="sm:col-span-2 rounded-lg cursor-pointer text-center py-2 px-2">
                            <label class="cursor-pointer">
                                <div @click="form.template='default'" class="flex flex-col items-center">
                                    <img src="{{ url('img/invoice_templates/default.png') }}" class="h-60 my-3" alt="Default" />
                        ...
                        <div class="sm:col-span-2 rounded-lg cursor-pointer text-center py-2 px-2">
                            <label class="cursor-pointer">
                                <div @click="form.template='classic'" class="flex flex-col items-center">
                                    <img src="{{ url('/img/invoice_templates/classic.png') }}" class="h-60 my-3" alt="Classic" />
                        ...
                        <div class="sm:col-span-2 rounded-lg cursor-pointer text-center py-2 px-2">
                            <label class="cursor-pointer">
                                <div @click="form.template='modern'" class="flex flex-col items-center">
                                    <img src="{{ url('/img/invoice_templates/modern.png') }}" class="h-60 my-3" alt="Modern" />
